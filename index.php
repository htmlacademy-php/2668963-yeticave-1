...
$user_name = 'Gera'; // укажите здесь ваше имя
$categories = ["Доски и лыжи", "Крепления", "Ботинки", "Одежда", "Инструменты", "Разное"];
$ads = 
[
["name"=>"2014 Rossignol District Snowboard", "cat"=>$categories[0], "price"=>10999, "URL_img"=>"img/lot-1.jpg"],
["name"=>"DC Ply Mens 2016/2017 Snowboard", "cat"=>$categories[0], "price"=>159999, "URL_img"=>"img/lot-2.jpg"],
["name"=>"Крепления Union Contact Pro 2015 года размер L/XL", "cat"=>$categories[1], "price"=>8000, "URL_img"=>"img/lot-3.jpg"],
["name"=>"Ботинки для сноуборда DC Mutiny Charocal", "cat"=>$categories[2], "price"=>10999, "URL_img"=>"img/lot-4.jpg"],
["name"=>"Куртка для сноуборда DC Mutiny Charocal", "cat"=>$categories[3], "price"=>7500, "URL_img"=>"img/lot-5.jpg"],
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$ad["URL_img"]?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$ad["cat"]?></span>
