...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <form class="main-header__search" method="get" action="index.php" autocomplete="off">
            <input type="hidden" name="source" value="search-page">
        ...
        <?php if (isset($_SESSION['username'])): ?>
            <div class="user-menu__logged">
                <p><?= $userName ?></p>
                <a class="user-menu__bets" href="index.php?source=my-bets">Мои ставки</a>
...
<main>
    <?php if (isset($_GET['source']) && $_GET['source'] !== null) : ?>
        <nav class="nav">
        <ul class="nav__list container">
            <?php foreach ($categories as $category): ?>
                <?php $classname = (($_GET['source'] === 'lots-by-category') && $category['code'] === $_GET['cat']) ? 'nav__item--current' : ''; ?>
                <li class="nav__item <?= $classname ?>">
                    <a href="/index.php?source=lots-by-category&cat=<?= $category['code'] ?>"><?= $category['title'] ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </nav>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php foreach ($categories as $category): ?>
                <?php $classname = (isset($_GET['source']) 
                && ($_GET['source'] === 'lots-by-category') 
                && $category['code'] === $_GET['cat']) ? 'nav__item--current' : ''; ?>
                <li class="nav__item <?= $classname ?>">
                    <a href="/index.php?source=lots-by-category&cat=<?= $category['code'] ?>"><?= $category['title'] ?></a>
                </li>
            <?php endforeach; ?>
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" href="/index.php?source=add">Добавить лот</a>
